      ...
      <section className="bg-gradient-to-r from-blue-500 to-indigo-700 text-white text-center py-20">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-x-4">
            <Link href="/signup" className="bg-yellow-500 text-black py-2 px-6 rounded-lg hover:bg-yellow-400 transition duration-300">Start Your Free Trial</Link>
            <Link href="/features" className="bg-transparent border-2 border-white text-white py-2 px-6 rounded-lg hover:bg-white hover:text-black transition duration-300">Learn More</Link>
          </div>
        </div>
      </section>
    )
