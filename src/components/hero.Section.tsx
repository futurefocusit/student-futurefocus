    ...
    return (
      <section className="bg-gradient-to-r from-blue-500 to-indigo-700 text-white text-center py-20">
        <div className="max-w-2xl mx-auto">
          <h1 className="text-4xl sm:text-5xl font-extrabold mb-6">Simplifying Education Management</h1>
          <p className="text-lg sm:text-xl mb-8">Xcool empowers institutions to manage students, track attendance, and streamline cash flow all in one place.</p>
